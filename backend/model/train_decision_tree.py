...
def main(args):
    ...
    eval_path = out_dir / "decision_tree_evaluation.json"
    ...
    test_out.to_csv(out_dir / "decision_tree_test_predictions.csv", index=False)

    # Save model
    model_path = out_dir / "decision_tree.joblib"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Decision Tree for difficulty prediction")
